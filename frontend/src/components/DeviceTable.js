...
const DeviceTable = ({ devices, role, selectedDevices, editedDevices, handleCheckboxChange, handleEditChange, handleReserve, handleDelete, handleApplyChanges, handleSortByDate, sortOrder }) => {
  return (
    <table>
      <thead>
        <tr>
